...
//! # aes_core
//! `aes_core` is an implement of AES crypto algorithm all coded in pure rust-lang.
...
//! Otherwise, the functions will panic `at 'index out of bounds'`, or maybe even worse.
// S-Box
const SBOX: [u8; 256] = [
